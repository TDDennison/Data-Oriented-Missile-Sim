...
bool InputFileParser::TryParse(std::filesystem::path filePath) 
{
...
std::string InputFileParser::GetLine(std::ifstream& inFile)
{
    std::string line;
...
void InputFileParser::RemoveComments(std::string& line)
{
...
void InputFileParser::LeftTrim(std::string &s)
{
...
void InputFileParser::RightTrim(std::string &s)
{
...
void InputFileParser::TrimWhitespaceFromEnds(std::string &s) {
    LeftTrim(s);
    RightTrim(s);
...
bool InputFileParser::isReservedAttribute(std::string attributeName)
{
...
bool InputFileParser::isNorthOrSouth(std::string latitudeStr)
{
...
// Throws exception if neither.
bool InputFileParser::isEastOrWest(std::string longitudeStr)
{
...
void InputFileParser::ParseReservedAttribute(std::string attributeName, std::ifstream &inFile)
{
    if (attributeName == DomSim::Constants::RESERVED_ATTRIBUTE_MISSILE_STARTING_LOCATIONS)
    {
        ParseMissileStartingLocations(inFile);
    }
    else if (attributeName == DomSim::Constants::RESERVED_ATTRIBUTE_TARGET_POINTS)
    {
...
void InputFileParser::ParseMissileStartingLocations(std::ifstream &inFile)
{
...
void InputFileParser::ParseTargetPoint(std::ifstream &inFile)
{
